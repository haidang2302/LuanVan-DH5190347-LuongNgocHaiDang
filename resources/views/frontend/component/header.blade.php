                        ...
                        @if(auth()->guard('customer')->check())
                            <div class="header-cart">
                                <div class="uk-flex uk-flex-middle">
                                    ...
                                    <a style="color: #716DF2;" href="{{ route('customer.logout') }}" class="cart-text"> [Đăng xuất]</a>
                                </div>
                            </div>
                ...
                <div class="mobile-widget">
                    <div class="uk-flex uk-flex-middle">
                        ...
                        <a href="#mobileCanvas" class="mobile-menu-button" data-uk-offcanvas>
                            ...
                            viewBox="0 0 1536 1896.0833" class="" fill="rgb(113,109,242)"> <path d="M1536 1344v128q0 26-19 45t-45 19H64q-26 0-45-19t-19-45v-128q0-26 19-45t45-19h1408q26 0 45 19t19 45zm0-512v128q0 26-19 45t-45 19H64q-26 0-45-19T0 960V832q0-26 19-45t45-19h1408q26 0 45 19t19 45zm0-512v128q0 26-19 45t-45 19H64q-26 0-45-19T0 448V320q0-26 19-45t45-19h1408q26 0 45 19t19 45z"></path> </svg>
                        </a>
                    </div>
                </div>
            </div>
